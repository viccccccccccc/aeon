...
from aeon.transformations.spikelet.Spikelet_Stat_decide_binsize import (
    Spikelet_Stat_decide_binsize,
)
from aeon.transformations.spikelet.Spikelet_Stat_knee_find_poly_for_XY import (
    Spikelet_Stat_knee_find_poly_for_XY,
)
...
def Spikelet_Stat_knee_find_of_mag_using_magband_support(M, S, Func, BandFunc):
    ...
    if Func_fwd == "poly" and Func_bwd == "poly":
        MagThr, KneeInfo = Spikelet_Stat_knee_find_poly_for_XY(
            M_band, S_band, Dim_fwd, Dim_bwd
        )
    else:
    ...
    if PLOT and Func_fwd == "poly" and Func_bwd == "poly":
        fig_1, fig_2, fig_3 = plot_scatter_MS(
            M, S, M_band, S_band, MagThr, KneeInfo, BandFunc
        )
